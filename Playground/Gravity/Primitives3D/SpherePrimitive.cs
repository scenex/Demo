...
namespace Primitives3D
{
    ...
    public class SpherePrimitive : GeometricPrimitive
    {
        ...
        /// </summary>
        public SpherePrimitive(GraphicsDevice graphicsDevice, Vector3 position, Vector3 force, float mass) : this(graphicsDevice, 0.25f, 16)
        {
        ...
        public override sealed Vector3 Position { get; set; }
        public override sealed Vector3 Force { get; set; }
        public override sealed float Mass { get; set; }
